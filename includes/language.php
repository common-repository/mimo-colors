 ...
 */
function mimo_colors_get_language() {
 ...
 */
function mimo_colors_register_string( $plugin_name_human_format, $string_name, $value ) {
 ...
 * @param     string   $string_name               The name of the string
 */
function mimo_colors_deregister_string( $plugin_name_human_format, $string_name ) {
 ...
 * @param     string   $value					  The value
 */
function mimo_colors_get_string( $plugin_name_human_format, $string_name, $value ) {
