 ...
 * Wpcolors_Requirements: only required the declaration, check the minimum value inserted, call directly the warning
 * Plugin_requirements: support multiple plugin
 * Requirement_Error: compacted code, better css, added deactivation of the plugin
 */

if ( class_exists( 'Wpcolors_Requirements' ) === false ) {
    ...
    class Wpcolors_Requirements {
         ...
         * 
         * @param    string    $pluginname The Mimo Colors used for the warning
    ...
    /**
     * Check the PHP environment, for example go to Wpcolors_Requirements documentation
     *
     * @package Mimo_Colors_Display
     * @author  Mte90 and dsawardekar
     */
    ...
    /**
     * Check the Wordpress environment, for example go to Wpcolors_Requirements documentation
     *
     * @package Mimo_Colors_Display
     * @author  Mte90 and dsawardekar
     */
    ...
    /**
     * Check the PHP extension, for example go to Wpcolors_Requirements documentation
     *
     * @package Mimo_Colors_Display
     * @author  Mte90 and dsawardekar
     */
    ...
    /**
     * Check the plugin required, for example go to Wpcolors_Requirements documentation
     *
     * @package Mimo_Colors_Display
     * @author  Mte90 and dsawardekar
     */
     ...
     * @author  Mte90 and dsawardekar
     */
    class Wpcolors_Requirements_Exception extends \Exception {
    ...
    class Requirement_Error {
        ...
        function showError( $message ) {
            if ( $this->isErrorScraper() ) {
                ...
                throw new Wpcolors_Requirements_Exception();
            }
        }
